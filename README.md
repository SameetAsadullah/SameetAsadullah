<h1 align="center">Sameet Asadullah</h1>

<p align="center">
  Machine Learning Engineer building production AI systems across LLMs, computer vision, image generation, and scalable ML infrastructure.
</p>
...
- Scalable inference platforms for image generation and multimodal AI workloads
...
- Shipped large-scale image generation infrastructure at Vyro for apps serving millions of users, including systems handling peaks of 20M requests per day with 99.5% uptime.
- Reduced avatar generation turnaround from hours to 15 minutes by implementing a Docker-based serverless training and inference pipeline on AWS and Runpod.
